...
public class Texture2dProgram {
     ...
     */
    public static Texture2dProgram create(ProgramType programType) {
        Texture2dProgram program;
        switch (programType) {
            case TEXTURE_2D:
                program = new Texture2dProgram(GLES20.GL_TEXTURE_2D, VERTEX_SHADER, FRAGMENT_SHADER_2D);
                break;
            case TEXTURE_EXT:
                program = new Texture2dProgram(GLES11Ext.GL_TEXTURE_EXTERNAL_OES, VERTEX_SHADER, FRAGMENT_SHADER_EXT);
                break;
            case TEXTURE_EXT_BW:
                program = new Texture2dProgram(GLES11Ext.GL_TEXTURE_EXTERNAL_OES, VERTEX_SHADER, FRAGMENT_SHADER_EXT_BW);
                break;
            case TEXTURE_EXT_FILT:
                program = new Texture2dProgram(GLES11Ext.GL_TEXTURE_EXTERNAL_OES, VERTEX_SHADER, FRAGMENT_SHADER_EXT_FILT);
                break;
            default:
    ...
    public Texture2dProgram(int textureTarget, String vertShader, String fragShader) {
        mTextureTarget = textureTarget;
        mProgramHandle = GlUtil.createProgram(vertShader, fragShader);
        if (mProgramHandle == 0) {
